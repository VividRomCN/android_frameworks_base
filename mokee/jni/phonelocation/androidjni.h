 ...
 */
#define JNIREG_CLASS_LOCATION "android/mokee/location/PhoneLocation"
 ...
 */
static JNINativeMethod gMethods_Location[] = {
    {
...
#define JNIREG_CLASS_UTIL "android/mokee/utils/MoKeeUtils"
JNIEXPORT jboolean JNICALL isSupportLanguage (JNIEnv* env, jclass thiz, jboolean excludeTW);

/**
 * Table of methods associated with a single class.
 */
static JNINativeMethod gMethods_Utils[] = {
    {
