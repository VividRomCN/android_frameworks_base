...
static const char LOC_FILE[] = "/system/media/location/phonelocation.dat";
...
JNIEXPORT jstring JNICALL
    ...
    if (len < 3) return NULL;
#ifdef DEBUG
    __android_log_print(ANDROID_LOG_DEBUG, TAG, "getPhoneNumberLocation: parse = %s %d", phone2, len);
#endif
